        ...
        <div class="content sm-gutter">
            <div class="container-fluid padding-25 sm-padding-10 py-2">
                <div class="card card-default mt-3">
                    ...
                    <form action="{{ url('manager/exercise/goals/'.$goal->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="80" placeholder="Title" value="{{ $goalEn->title }}" name="title_en" class="form-control" required>
                                        @error('title_en')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="80" placeholder="Title" value="{{ $goalAr->title }}" name="title_ar" class="form-control" required>
                                        @error('title_ar')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
