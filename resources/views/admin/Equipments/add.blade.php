    ...
    <div class="page-content-wrapper">
        ...
        <div class="content sm-gutter">
            ...
            <div class="card card-default mt-3">
                    ...
                    <form action="{{ url('manager/equipments') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="80" placeholder="Title" name="title_en" class="form-control">
                                                    @error('title_en')
                                ...
                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="80" placeholder="Title" name="title_ar" class="form-control">
                                                    @error('title_ar')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
